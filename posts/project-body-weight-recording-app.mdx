...
<Future>I felt like I had everything I needed to start making an HTMX application, so I made a new page and started to solidify the authentication flow and show a table and a form to upload new data.</Future>
