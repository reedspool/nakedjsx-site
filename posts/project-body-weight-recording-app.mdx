...
<Future>I got rid of my CDN import of supabase, now that I'd figured out how to compile properly for the frontend</Future>
...
<Future>I made a 404 page with a link back to the homepage, and a 5XX page similarly, instead of getting stranded with a (dangerous in production?) stack trace</Future>

<Future>I tried to remember how I dealt with timestamps on my last application. I was already struggling with a consistent view on time.</Future>
...
<Future>I added user settings with whether to use kilograms or pounds</Future>
