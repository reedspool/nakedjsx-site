...
{`behavior game
    ...
    def nextLevel
      ...
      if $level is 1
        ...
        put "hunt cheesy smelly hurried dependent punch whole sleep uninterested beds night private accessible optimal bare married defiant receipt incandescent needy rigid spiky fair" into $allRemaining
        getNextCharacter()
        exit
      end
