...
<span class="!text-green-600"></span><span class="!text-amber-600 !underline !underline-offset-1 whitespace-pre-wrap"></span><span class="">Type the next character with an amber underline.</span>
`}</div>
