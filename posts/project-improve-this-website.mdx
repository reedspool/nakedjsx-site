...
To write [this script](https://github.com/reedspool/nakedjsx-site/blob/main/bin/generate-post-imports.mjs#L1) was as easy as copying and pasting the contents of my development server script which essentially did the same thing. I just wrote the result to a file instead of returning it from a dynamic script.
...
so that my component could convert `../../src/filename.jsx` to `src/filename.jsx` and derive `https://github.com/reedspool/nakedjsx-site/blob/main/src/filename.jsx` by tacking it onto the normal GitHub base link.

Previously, I had been typing both links and both paths in Markdown, like this:

```
[here (local, won't work on the web)](../src/compile-all-posts-client.jsx) or [here (global, GitHub)](https://github.com/reedspool/nakedjsx-site/blob/main/src/compile-all-posts-client.jsx#L1)
```
