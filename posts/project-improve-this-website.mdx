...
I saw an opportunity to combine the "Link" and "HashTarget" into one component, thuogh that would only reduce some typing. It wouldn't help me with the mental effort of coming up with an ID like that nor adding it as a check.
