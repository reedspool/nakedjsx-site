...
How was my behavior different since my experience at Recurse Center? Well, as per the organizations focus on training volition, my time on the computer was both more directed and more full. More directed because I had many immediate "next steps" to perform on a variety of efforts from hosting to homework for several weekly commitments I made for the duration of the program. And more full, as when I opened my computer each morning I found 22 tabs opened waiting for a curious glance.
