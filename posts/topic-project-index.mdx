...
I started making <Link slug="project-counting-up-party-game">a page</Link> for printable, reproduceable cards for a party game I'd started to design. 
...
I started this post <Link slug="project-explore-uxn-and-playdate">here</Link>.
