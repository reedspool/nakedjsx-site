...
Before moving on, I wanted to verify that the code would work, so I added it to [my compilation script](https://github.com/reedspool/nakedjsx-site/blob/6bcaf25e60d2170a5bb9e132d2a93c9878163588/src/compile-all-posts-page.jsx#L1).
...
<Future>I added links to my page for RSS the feed.</Future>

<Future>I made a new page that would be a reverse-chronological change-log from which my RSS feed would be generated.</Future>
