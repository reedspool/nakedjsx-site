...
<div>
  <button class="cpnt-button">Fast-forward <i class={`bx bx-fast-forward align-middle ml-sm inline-block`} /></button>
</div>
...
<Future>I moved the game out of this page and into its own page separate from the styles and chrome of the rest of my website.</Future>
