...
<button class="cpnt-button mb-4" 
  x="on click ' table' me next select' button' foreach I ' click' emit endForEach"
  _="on click trigger click on <button /> in next <table /> ">Toggle all code</button>
