...
| `sleep`         | <span c="now 750 sleep now swap - 749 > ' ✅' && me >text ">🚧</span>                      |
| After `sleep`   | <span c="' ✅' me >text">🚧</span>                                                    |
| `:` and `sleep` | <span c=": sleepier now 750 sleep now swap - 749 > ' ✅' && ; sleepier me >text">🚧</span> |
...
The solution I imagined was for my colon definition implementation to change the state of the interpreter. As it was, the colon definition implementation simply looped synchronously.
