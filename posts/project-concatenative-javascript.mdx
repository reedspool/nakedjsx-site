...
<table>
    ...
    <tbody>
        ...
        <tr> <td> <code>immediate</code>, <code>,</code>, <code>tick</code>, <code>lit</code> </td> <td> <span c=": check immediate tick lit , ' ✅' , ; : pushCheck ' ❌' check ; pushCheck me >text">🚧</span> </td> </tr>
        ...
        <tr> <td>Floats <code>+</code> like JS</td> <td> <span c="0.1 0.2 + dup 0.3 > swap 0.31 < && ' ✅' && me >text">🚧</span> </td> </tr> 
        <tr> <td> <code>\*</code> and <code>/</code> </td> <td> <span c="10 1.5 * 5 / 3 == ' ✅' && me >text">🚧</span> </td> </tr> 
        <tr> <td>Floats <code>*</code> like JS</td> <td> <span c="0.1 0.2 * dup 0.02 > swap 0.021 < && ' ✅' && me >text">🚧</span> </td> </tr> 
        ...
        <tr> <td> <code>branch</code></td> <td> <span c=": 3, immediate 3 , ; : branchy ' ✅' branch 3, ' ❌1' ' ❌2' drop ; branchy me >text">🚧</span> </td> </tr>
        <tr> <td> <code>0 0branch</code></td> <td> <span c=": branchy ' ✅' 0 0branch 3, ' ❌1' ' ❌2' drop ; branchy me >text">🚧</span> </td> </tr>
        <tr> <td> <code>1 0branch</code></td> <td> <span c=": branchy ' ❌1' 1 0branch 3, ' ✅' ' ❌2' drop ; branchy me >text">🚧</span> </td> </tr>
        <tr> <td>Falsy <code> falsyBranch</code></td> <td> <span c=": branchy ' ✅' ' ' falsyBranch 3, ' ❌1' ; branchy me >text">🚧</span> </td> </tr>
        <tr> <td>Truthy <code> falsyBranch</code></td> <td> <span c=": branchy ' ❌1' true falsyBranch 3, ' ✅' ; branchy me >text">🚧</span> </td> </tr>
        <tr> <td> <code>true if</code> </td> <td> <span c=": iffy ' ❌' true if ' ✅' endif ; iffy me >text">🚧</span> </td> </tr> 
        <tr> <td> <code>false if</code> </td> <td> <span c=": iffy ' ✅' false if ' ❌' endif ; iffy me >text">🚧</span> </td> </tr> 
        <tr> <td> <code>true if/else</code> </td> <td> <span c=": iffy true if ' ✅' else ' ❌' endif ; iffy me >text">🚧</span> </td> </tr> 
        <tr> <td> <code>false if/else</code> </td> <td> <span c=": iffy false if ' ❌' else ' ✅' endif ; iffy me >text">🚧</span> </td> </tr> 
        <tr> <td> <code>begin/until</code> </td> <td> <span c=": countDown begin 1 - dup 1 < until ; 5 countDown 0 === ' ✅' &&  me >text">🚧</span> </td> </tr> 
